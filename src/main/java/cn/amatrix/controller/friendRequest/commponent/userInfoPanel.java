...
public class userInfoPanel extends JPanel {
    ...
    public userInfoPanel(int width, User user, ActionListener sendRequestListener) {
        setLayout(new BorderLayout());
        setPreferredSize(new Dimension(width, FIXED_HEIGHT)); // 宽度为0表示自动调整，高度固定
        ...
        initUserIdLabel(String.format("%08d", user.getUser_id()));
