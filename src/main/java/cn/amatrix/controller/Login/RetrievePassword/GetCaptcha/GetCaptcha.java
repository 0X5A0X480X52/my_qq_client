package cn.amatrix.controller.Login.RetrievePassword.GetCaptcha;

import cn.amatrix.controller.Login.LoginGUI1;
import cn.amatrix.controller.Login.RetrievePassword.RetrievePassword;
...
public class GetCaptcha extends JFrame implements WebSocketReceiver {
    ...
    static {try {
        ...
        fileHandler.setFormatter(new SimpleFormatter());logger.addHandler(fileHandler);
    } catch (Exception e) {
    ...
    public GetCaptcha(String username, String email, String captcha) {
    ...
    void init() {
        ...
        newpasswordField.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (newpasswordField.equals("input password")) {
        ...
        passwordField.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                if (passwordField.equals("iuput password again")) {
