package cn.amatrix.service.signUp;
...
public class SignUpService {
    ...
    public enum EmailVerificationCodeStatus {
        TIMEOUT, INVALID, SUCCESS, EMAILED, FAILED, UNKNOWN
    } 
    ...
    public SignUpService( WebSocketClient client ) throws IllegalArgumentException {
